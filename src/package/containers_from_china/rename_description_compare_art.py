def main(template_file_path="X:/AUR/10.2024/21.10.2024 - Copy/noul template.xlsx"):
# def main(template_file_path="X:/AUR/21.10.2024 - Copy/noul template.xlsx"):
    ...
    def change_value(value):
        replacing_el = ["#", ".", "Ă", "Â", "Î", "Ș", "Ț", "PR.", "*", "APT.", " COD ", "COL.COD", "ARTICOLUL", "COD PR.", ".ART.ART.", "ART.ART.", "ART ART.", "ART ART", " ART ART ", "IN STOC", "ART.PR", "ART PR", "UN SET", "IN SORTIMENT", " ,", "#", '"', "NR ", "ART ", "SETUL", " PR ", " SORT ", "FUNCTIONEAZA", "PENTRU", "PT.", "IN ASORTIMENT", "DE", "SKU"]
        replacing_with = [" ", " ", "A", "A", "I", "S", "T", " ART.", "x", " ART.", " ART.", " ART.", " ART.", " ART.", " ART.", " ART.", " ART.", " ART.", " ART.", "", " ART.", " ART.", "SET", "", "", " ", "", "NR.", "ART.", "SET", "ART.", "", "PE", "PT", "PT", "", "", "ART."]
